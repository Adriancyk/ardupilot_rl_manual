...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:RL_ZigZag,25:SystemID,26:Heli_Autorotate,27:Auto RTL,29:RL_Manual
    // @User: Standard
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:RL_ZigZag,25:SystemID,26:Heli_Autorotate,29:RL_Manual
    // @User: Advanced
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Group: ZIGZ_
    // @Path: mode_RL_zigzag.cpp
    //AP_SUBGROUPPTR(mode_RL_zigzag_ptr, "ZIGZ_", 38, ParametersG2, ModeRL_ZigZag),
#endif
...
#endif
#if MODE_RL_ZIGZAG_ENABLED == ENABLED
    //,mode_RL_zigzag_ptr(&copter.mode_RL_zigzag)
#endif
#if MODE_ACRO_ENABLED == ENABLED || MODE_SPORT_ENABLED == ENABLED
