...
public:
    ...
    enum class Number : uint8_t {
        ...
        RL_MANUAL =    29,  // MANUAL RL MODE, directly control [f, gyro1, gyro2, gyro3], f = t1+t2+t3+t4, t1/t2/t3/t4 = throttle from 4 rotors
...
class ModeRL_Manual : public Mode
{
public:
    // inherit constructor
    using Mode::Mode;
    ...
    Number mode_number() const override { return Number::RL_MANUAL; }
...
protected:
    const char *name() const override { return "RL_MANUAL"; }
    const char *name4() const override { return "RLMN"; }
